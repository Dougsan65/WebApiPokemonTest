...
document
    .getElementById('select-createChar01')
    .addEventListener('click', function () {
        ...
        confirmNameBtn.addEventListener('click', function () {
            ...
            const response = fetch(
                'https://api-nodejs-7vxu.onrender.com/criarpersonagem',
                {
                    method: 'POST',
                    headers: {
...
document
    .getElementById('select-createChar02')
    .addEventListener('click', function () {
        modal.classList.remove('hidden');
...
document
    .getElementById('select-createChar03')
    .addEventListener('click', function () {
        modal.classList.remove('hidden');
